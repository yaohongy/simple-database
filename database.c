...
PrepareResutlt prepare_insert(InputBuffer* input_buffer, Statement* statement) {
...
PrepareResutlt prepare_statement(InputBuffer* input_buffer, Statement* statement) {
